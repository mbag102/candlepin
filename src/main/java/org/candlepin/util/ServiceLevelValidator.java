...
public class ServiceLevelValidator {
    ...
    private static final int MAX_COL_LENGTH = 32;
    private I18n i18n;
     ...
     */
    private void validateLength(String entry) {
        if (entry.length() > MAX_COL_LENGTH) {
            throw new BadRequestException(i18n.tr(
                "Service level value must not exceed {0} characters.",
                MAX_COL_LENGTH));
        }
    }
}
