...
# amqp dir, keystore & truststore used by qpid JMS client
...
* Thu Jun 05 2014 jesus m. rodriguez <jesusr@redhat.com> 0.9.17-1
- Fix async bind for "my" system admins. (dgoodwin@redhat.com)
